...
await fs.cp('public/icons','dist/icons',{recursive:true});
for(const name of ['favicon.ico','favicon-16x16.png','favicon-32x32.png','apple-touch-icon.png'])await fs.copyFile('public/icons/'+name,'dist/'+name);
await fs.copyFile('public/site.webmanifest','dist/site.webmanifest');
...
await write('index.html',`<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>TikTok & Game Recharge | Coupon Countdown</title><meta name="description" content="Choose your language to find TikTok Coins and game recharge offers."><link rel="canonical" href="${origin}/"><meta property="og:title" content="TikTok &amp; Game Recharge"><meta property="og:description" content="TikTok coins and game recharge links."><meta property="og:url" content="${origin}/"><meta property="og:type" content="website">${iconHead(origin)}<link rel="stylesheet" href="${assets.css}"><script type="module" src="${assets.js}"></script>${localeOrder.filter(x=>locales[x]).map(l=>`<link rel="alternate" hreflang="${locales[l].tag}" href="${origin}/${l}/">`).join('')}<link rel="alternate" hreflang="x-default" href="${origin}/en/"></head><body data-root="true"><main class="language-landing"><p class="eyebrow">COUPON COUNTDOWN · RECHARGE HUB</p><h1>TikTok Coins.<br>Your favorite games.</h1><p>Choose your language</p><nav class="language-options">${localeOrder.filter(x=>locales[x]).map(l=>`<a href="/${l}/" lang="${locales[l].tag}" data-language="${l}">${locales[l].label}</a>`).join('')}</nav></main></body></html>`);
await write('404.html',`<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="robots" content="noindex"><title>Page not found | Coupon Countdown</title>${iconHead(origin)}<link rel="stylesheet" href="${assets.css}"></head><body><main class="language-landing"><p>404</p><h1>Let's find your game.</h1><p>This page is no longer available.</p><a class="button" href="/">Find your game →</a></main></body></html>`);
...
for(const [from,to]of Object.entries(redirects)){if(!from.endsWith('/')&&!from.endsWith('.html'))continue;await write(from.endsWith('/')?from.slice(1)+'index.html':from.slice(1),`<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="robots" content="noindex"><meta http-equiv="refresh" content="0;url=${to}"><link rel="canonical" href="${origin}${to}">${iconHead(origin)}<title>Page moved</title><script>location.replace(${JSON.stringify(to)}+location.search+location.hash)</script></head><body><a href="${to}">Continue to recharge</a></body></html>`);}
