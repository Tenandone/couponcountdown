...
const lastGood=previous||(index.latest?JSON.parse(await fs.readFile(`data/markets/weeks/${index.latest}.json`,'utf8').catch(()=>'null')):null);
...
if(!report.publishable){console.warn('::warning::No usable weekly data; previous published edition retained');process.exit(0);}
